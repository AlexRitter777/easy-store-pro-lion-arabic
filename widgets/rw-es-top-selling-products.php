...
class Rw_Easy_Store_Top_Selling_Products extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            'classname'                     => 'rw_easy_store_top_selling_products',
            'description'                   => __( 'Display WooCommerce top selling product lists.', 'easy-store-pro' ),
            'customize_selective_refresh'   => true,
        );
        parent::__construct( 'rw_easy_store_top_selling_products', __( 'ES: RW Top Selling Products', 'easy-store-pro' ), $widget_ops );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $product_args = array(
            'post_type'      => 'product',
            'posts_per_page' => absint( $es_product_count ), // Количество товаров
            'meta_key'       => 'total_sales', // Указываем поле для сортировки
